...
function parseHSL(hslStr: string) {
  ...
  if (!match) return { h: 11, s: 87, l: 74 };
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  style,
  edgeSensitivity = 30,
  glowColor = '11 87 74', // matches --accent-pink #f79882 HSL(11, 87%, 74%)
  backgroundColor = '#0A0A0A', // matches --bg-color #0A0A0A
  borderRadius = 28,
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ['#ff1d1d', '#800000', '#f79882'], // matches site accents (--accent-cyan, --accent-purple, --accent-pink)
  fillOpacity = 0.5,
}) => {
